...
- **Limitação conhecida v1:** mensagens enviadas pelo operador direto do celular (`fromMe=true`) não são capturadas na timeline ainda (diferente do WAHA) — ver `lib/evolution/ingest.ts`.
