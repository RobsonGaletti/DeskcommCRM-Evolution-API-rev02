...
const config: VercelConfig = {
  // Os 3 crons por minuto (agent-dispatcher, routing-worker, event-log-drain)
  // ficaram de fora: plano Hobby só permite cron diário ("Hobby accounts are
  // limited to daily cron jobs" — bloqueia o deploy). Reative ao migrar pra
  // Pro, ou chame os endpoints via cron externo (GitHub Actions, Upstash
  // QStash, etc.) enquanto isso — sem eles, dispatch de IA/roteamento/drain
  // de event_log não rodam automaticamente.
